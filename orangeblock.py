...
class StereoVision:
    def __init__(self, left_camera, right_camera):
        self.capl = cv2.VideoCapture(left_camera)
        self.capr = cv2.VideoCapture(right_camera)
                ...
                for cntl in contoursl:
                    ...
                    if Ml["m00"] != 0:
                        ...
                        if self.clX != reglX or self.clY != reglY:
                            print("左相机目标点： ", self.clX, self.clY)
            ...
            for cntr in contoursr:
                ...
                if Mr["m00"] != 0:
                    ...
                    if self.crX != regrX or self.crY != regrY:
                        print("右相机目标点： ",self.crX, self.crY)
