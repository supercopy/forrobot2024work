...
class HomographyMapper: 
    ...
    def __init__(self, points_1, points_2):
        ...
        self.H_4x4 = np.pad(H, ((0, 1), (0, 1)), mode='constant', constant_values=0) #填充为4x4的矩阵，((0, 1), (0, 1)) 的意思是上面填充0行，下面填充1行，左边填充0列，右边填充1列。
        self.H_4x4[3, 3] = 1 # 第四行第四列的值为1
        print(self.H_4x4)
...
mapped_points_3d_2 = mapper.map_points_with_homography(np.array(points_1))
should = np.array([[0.5, 1.5, 2.5], [3.5, 4.5, 5.5], [6.5, 7.5, 8.5], [9.5, 10.5, 11.5]])

print("Mapped Points in Second 3D Coordinate System:")
print(mapped_points_3d_2)

print("Should be:", should)