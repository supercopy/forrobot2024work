...
# -------------------------------------------------------------------------------------------------------------
# 左镜头的内参，如焦距
array_datal = np.array([[689.785263375330, 0, 603.186305146634],
                           [0, 681.819856861341, 347.160797335265],
                           [0, 0, 1]])
array_datar = np.array([[680.651938094339, 0, 628.040813225271],
                          [0, 673.433239555345, 344.705621944320],
                          [0, 0, 1]])
...
# 畸变系数,K1、K2、K3为径向畸变,P1、P2为切向畸变,次序为k1,k2,p1,p2,k3   
left_distortion = np.array([[0.0590774719594520, -0.0275425223446535, 0.000880646381001658, -0.00414163224466117, -0.0702987899761539]])
right_distortion = np.array([[0.0643896520921237, -0.0380297825406730, 0.000405940916324204, 0.00186815836257987, -0.0634872580310291]])

# left_distortion = np.array([[0, 0, 0, 0, 0]])
# right_distortion = np.array([[0, 0, 0, 0, 0]])

# 旋转矩阵
R = np.array([[0.998052559705373, 0.0498997039816976, -0.0374313719771599],
                  [-0.0497652960942212, 0.998750736842573, 0.00451452777944091],
                  [0.0376098839430282, -0.00264295269647576, 0.999289002957021]])
# 平移矩阵
T = np.array([-142.623673544595, 5.14466954585366, -2.30970147260524])
